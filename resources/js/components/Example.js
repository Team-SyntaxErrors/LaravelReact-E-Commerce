                ...
                <div className="container-fluid">
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="card">
                                <div className="card-header"><h3>Data Table</h3></div>
                                <div className="card-body">
                                    <table id="data_table" className="table">
                                        ...
                                        <tr>
                                            <td>001</td>
                                            <td><img src="../img/users/1.jpg" className="table-user-thumb" alt/></td>
                                            <td>Erich Heaney</td>
                                        ...
                                        <tr>
                                            <td>002</td>
                                            <td><img src="../img/users/2.jpg" className="table-user-thumb" alt/></td>
                                        ...
                                        <tr>
                                            <td>003</td>
                                            <td><img src="../img/users/3.jpg" className="table-user-thumb" alt/></td>
                                        ...
                                        <tr>
                                            <td>004</td>
                                            <td><img src="../img/users/4.jpg" className="table-user-thumb" alt/></td>
                                        ...
                                        <tr>
                                            <td>005</td>
                                            <td><img src="../img/users/5.jpg" className="table-user-thumb" alt/></td>
                    ...
                    <div className="row">
                        <div className="col-sm-12">
                            ...
                            <div className="card">
                                ...
                                <div className="card-body">
                                    <div className="dt-responsive">
                                        <table id="complex-dt" className="table table-striped table-bordered nowrap">
                                            <thead>
                                            <tr>
                            ...
                            <div className="card">
                                ...
                                <div className="card-body">
                                    <div className="dt-responsive">
                                        <table id="DOM-dt" className="table table-striped table-bordered nowrap">
                                            <thead>
                                            <tr>
                                                <th>Name</th>
                                                <th>Position</th>
                            ...
                            <div className="card">
                                ...
                                <div className="card-body">
                                    <div className="dt-responsive">
                                        <table id="alt-pg-dt" className="table table-striped table-bordered nowrap">
                                            <thead>
                                            <tr>
                                                <th>Name</th>
                                                <th>Position</th>
                            ...
                            <div className="card">
                                ...
                                <div className="card-body">
                                    <div className="dt-responsive">
                                        <table id="scr-vrt-dt" className="table table-striped table-bordered nowrap">
                                            <thead>
                                            <tr>
                                                <th>Name</th>
                                                <th>Position</th>
