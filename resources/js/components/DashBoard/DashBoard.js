                                    ...
                                    <div className="qickview-wrap">
                                        <div className="desc">
                                            <p>
                                                ...
                                                posuere ornare at a ante.
                                                Quisque nec libero facilisis,
                                                egestas tortor eget, mattis dui.
                                                Curabitur viverra laoreet ligula
                                                at hendrerit. Nullam
                                                sollicitudin maximus leo, vel
                                                pulvinar orci semper id. Donec
                                                vehicula tempus enim a
                                                facilisis. Proin dignissim
                                                porttitor sem, sed pulvinar
                                                tortor gravida vitae.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="item-inner">
                                        ...
                                        <div className="list-title">
                                            <a>
                                                ...
                                                molestie, finibus lacus at,
                                                suscipit mi. Nunc luctus lacus
                                    ...
                                    <div className="item-inner">
                                        ...
                                        <div className="list-title">
                                            <a>
                                                ...
                                                sodales sit amet, semper sit
                                                amet enim. Duis pretium, nisi id
                                                pretium ornare, tortor nibh
                                                sodales tellus.
                                            </a>
                                        </div>
                                        <div className="list-actions">
            ...
            <div className="chat-panel" hidden>
                <div className="card">
                    <div className="card-header d-flex justify-content-between">
                        <a>
                            <i className="ik ik-message-square text-success" />
                        </a>
                            ...
                            <div className="messages">
                                <div className="message media reply">
                                    ...
                                    <div className="message-body media-body">
                                        <p>
                                            Epic Cheeseburgers come in all kind
                                            of styles.
                                        </p>
                                    </div>
                                </div>
                                <div className="message media">
                                    ...
                                    <div className="message-body media-body">
                                        <p>
                                            Cheeseburgers make your knees weak.
                                        </p>
                                    </div>
                                </div>
                                <div className="message media reply">
                                    ...
                                    <div className="message-body media-body">
                                        <p>
                                            Cheeseburgers will never let you
                                            down.
                                        </p>
                                        <p>
                                            They'll also never run around or
                                            desert you.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="message media reply">
                                    ...
                                    <div className="message-body media-body">
                                        <p>
                                            There's a cheesy incarnation waiting
                                            for you no matter what you palete
                                            preferences are.
                                        </p>
                                    </div>
                                </div>
                                <div className="message media">
                                    ...
                                    <div className="message-body media-body">
                                        <p>
                                            If you are a vegan, we are sorry for
                                            you loss.
                                        </p>
                                    </div>
                                </div>
