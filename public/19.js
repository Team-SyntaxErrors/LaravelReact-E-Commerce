...
/* harmony import */ var _pathofdev_react_tag_input_build_index_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @pathofdev/react-tag-input/build/index.css */ "./node_modules/@pathofdev/react-tag-input/build/index.css");
/* harmony import */ var _pathofdev_react_tag_input_build_index_css__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_pathofdev_react_tag_input_build_index_css__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _AddProduct_module_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./AddProduct.module.css */ "./resources/js/components/Views/Product/AddProduct.module.css");
/* harmony import */ var _AddProduct_module_css__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_AddProduct_module_css__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _Layouts_PageHeader_PageHeader__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./../Layouts/PageHeader/PageHeader */ "./resources/js/components/Views/Layouts/PageHeader/PageHeader.js");
/* harmony import */ var _pathofdev_react_tag_input__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @pathofdev/react-tag-input */ "./node_modules/@pathofdev/react-tag-input/build/module/index.js");
/* harmony import */ var simple_react_validator__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! simple-react-validator */ "./node_modules/simple-react-validator/dist/simple-react-validator.min.js");
/* harmony import */ var simple_react_validator__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(simple_react_validator__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var _helpers_slugger_Slugger__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../helpers/slugger/Slugger */ "./resources/js/components/helpers/slugger/Slugger.js");
...
/* harmony import */ var _customHooks_useForms__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../customHooks/useForms */ "./resources/js/components/customHooks/useForms.js");
...
var AddProduct = function AddProduct(props) {
  ...
  var simpleValidator = Object(react__WEBPACK_IMPORTED_MODULE_3__["useRef"])(new simple_react_validator__WEBPACK_IMPORTED_MODULE_10___default.a());

  var _useForms = Object(_customHooks_useForms__WEBPACK_IMPORTED_MODULE_13__["default"])({
    product_name: "",
    product_slug: "",
    product_sku: "",
    category_id: "",
  ...
  var slugger = function slugger(event) {
    ...
    setSlugWarning("");
    var slug = Object(_helpers_slugger_Slugger__WEBPACK_IMPORTED_MODULE_11__["default"])(name); // Check slug availability from database

    axios__WEBPACK_IMPORTED_MODULE_4___default.a.get("/product_slug_check/" + slug).then(function (response) {
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return axios__WEBPACK_IMPORTED_MODULE_4___default.a.get("/all_categories").then(function (response) {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return axios__WEBPACK_IMPORTED_MODULE_4___default.a.get("/subcategory_get/" + category_id).then(function (response) {
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return axios__WEBPACK_IMPORTED_MODULE_4___default.a.get("/all_brand_get").then(function (response) {
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return axios__WEBPACK_IMPORTED_MODULE_4___default.a.get("/all_unit_get").then(function (response) {
  ...
  var submitHandler = function submitHandler(event) {
    ...
    if (simpleValidator.current.allValid()) {
      axios__WEBPACK_IMPORTED_MODULE_4___default.a.post("/products", product).then(function (response) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_3__["Fragment"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_Layouts_PageHeader_PageHeader__WEBPACK_IMPORTED_MODULE_8__["default"], {
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("h3", null, "Add Product"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("button", {
    ...
    onBlur: slugger
  }), simpleValidator.current.message("product_name", product.product_name, "required"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("span", {
  ...
  }), simpleValidator.current.message("product_sku", product.product_sku, "required"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("span", {
    className: "text-danger"
  ...
  })), simpleValidator.current.message("category_id", product.category_id, "required"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("span", {
    className: "text-danger"
  ...
  })), simpleValidator.current.message("subcategory_id", product.subcategory_id, "required"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("span", {
    className: "text-danger"
  ...
  })), simpleValidator.current.message("brand_id", product.brand_id, "required"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("span", {
    className: "text-danger"
  ...
  }), simpleValidator.current.message("purchase_price", product.purchase_price, "required"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("span", {
    className: "text-danger"
  ...
  }), simpleValidator.current.message("sell_price", product.sell_price, "required"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("span", {
    className: "text-danger"
  ...
  })), simpleValidator.current.message("unit_id", product.unit_id, "required"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("span", {
    className: "text-danger"
  ...
  }), simpleValidator.current.message("product_alert_qty", product.product_alert_qty, "required"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("span", {
    className: "text-danger"
    ...
    className: "col-lg-12"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_pathofdev_react_tag_input__WEBPACK_IMPORTED_MODULE_9__["default"], {
    tags: product.tags,
    onChange: function onChange(newTags) {
      return setTags(newTags);
    },
    placeholder: "Product Tags"
  }), simpleValidator.current.message("tags", product.tags, "required"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("span", {
    className: "text-danger"
    ...
    value: "0"
  }, "Inactive")), simpleValidator.current.message("status", product.status, "required"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("span", {
    className: "text-danger"
    ...
    className: "col-lg-12"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_ckeditor_ckeditor5_react__WEBPACK_IMPORTED_MODULE_5__["CKEditor"], {
  ...
  }), simpleValidator.current.message("description", product.description, "required"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("span", {
    className: "text-danger"
...
/* harmony default export */ __webpack_exports__["default"] = (/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.memo(AddProduct));
