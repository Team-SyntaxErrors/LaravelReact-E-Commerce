...
var ProductList = function ProductList(_ref) {
  ...
  var changeStatus = function changeStatus(id) {
    axios__WEBPACK_IMPORTED_MODULE_4___default.a.get("/products/status/" + id).then(function (response) {
      if (response.data.code === 200) {
        react_toastify__WEBPACK_IMPORTED_MODULE_7__["toast"].success("This product is active!");
      }

      if (response.data.code === 201) {
        react_toastify__WEBPACK_IMPORTED_MODULE_7__["toast"].warning("This product is inactive!");
      }
